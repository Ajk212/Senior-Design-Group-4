...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.connect_push_button = QPushButton(self.widget)
        self.connect_push_button.setObjectName(u"connect_push_button")

        self.horizontalLayout_2.addWidget(self.connect_push_button)
